...
const DemandView = () => {
  ...
  const handleEditCenterDemand = async (recordId, allocatedQuantity) => {
    ...
    if (parseFloat(editingQuantity) > parseFloat(allocatedQuantity)) {
      setEditValidationError(
        `मांगी गई मात्रा Champawat, Champawat का कुल लक्ष्य (${allocatedQuantity}) से कम होनी चाहिए`,
      );
      return;
    }
    setIsSubmitting(true);
  ...
  const handleEditQuantityChange = (e, maxQuantity) => {
    ...
    if (value > maxQty) {
      setEditValidationError(
        `मांगी गई मात्रा (${value}) Champawat, Champawat का कुल लक्ष्य (${maxQty}) से अधिक नहीं हो सकती`,
      );
      return;
    }
    setEditValidationError("");
  ...
  const exportDemandsToExcel = () => {
    const exportData = filteredDemands.map((demand, index) => ({
      ...
      "Champawat, Champawat का कुल लक्ष्य": demand.allocated_quantity,
      इकाई: demand.unit,
  ...
  const exportDemandsToPDF = () => {
    ...
    const headers = [
      ...
      "उप-मद का नाम",
      "योजना का नाम",
      "Champawat, Champawat का कुल लक्ष्य",
      "इकाई",
      "कृषक विक्रय दर / अनुदान दर",
    ];
                        ...
                        >
                          <thead className="table-thead">
                            <tr>
                              ...
                              <th>उप-मद का नाम</th>
                              <th>योजना का नाम</th>
                              <th>Champawat, Champawat का कुल लक्ष्य</th>
                              <th>इकाई</th>
        ...
        <Modal.Body>
          {currentDemand && (
            <div>
              ...
              <Row className="mb-3">
                <Col md={6}>
                  <strong>Champawat, Champawat का कुल लक्ष्य:</strong>{" "}
