...
const DemandView = () => {
  ...
  const handleEditCenterDemand = async (recordId, allocatedQuantity) => {
    ...
    if (parseFloat(editingQuantity) > parseFloat(allocatedQuantity)) {
      setEditValidationError(`मांगी गई मात्रा Champawat, का कुल लक्ष्य (${allocatedQuantity}) से कम होनी चाहिए`);
      return;
    }
  ...
  const handleEditQuantityChange = (e, maxQuantity) => {
    ...
    if (value > maxQty) {
      setEditValidationError(`मांगी गई मात्रा (${value}) Champawat, का कुल लक्ष्य (${maxQty}) से अधिक नहीं हो सकती`);
      return;
    }
  ...
  const exportDemandsToExcel = () => {
    ...
    const exportData = filteredDemands.map((demand, index) => ({
      ...
      'Champawat, का कुल लक्ष्य': demand.allocated_quantity,
      'इकाई': demand.unit,
      'दर': demand.rate
    }));
  ...
  const exportDemandsToPDF = () => {
    ...
    // Add headers
    const headers = ['S.No.', 'उप निवेश नाम', 'Champawat, का कुल लक्ष्य', 'इकाई', 'दर'];
      ...
      <Modal show={showAddModal} onHide={() => handleCloseModal('add')}>
        ...
        <Modal.Body>
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              <Form.Label>Champawat,  का कुल लक्ष्य <span className="text-danger">*</span></Form.Label>
              <Form.Control
                type="number"
                step="0.01"
        ...
        <Modal.Body>
          {currentDemand && (
            <div>
              ...
              <Row className="mb-3">
                <Col md={6}>
                  <strong>Champawat, का कुल लक्ष्य:</strong> {currentDemand.allocated_quantity}
                </Col>
                <Col md={6}>
        ...
        <Modal.Body>
          ...
          {currentDemand && (
            <div className="border rounded p-3 bg-light">
              ...
              <p><strong>Champawat, का कुल लक्ष्य:</strong> {currentDemand.allocated_quantity}</p>
