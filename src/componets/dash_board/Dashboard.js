...
const translations = {
  home: "Home",
  welcomeMessage: "Champawat उद्यान विभाग डिजिटल प्लेटफॉर्म में आपका स्वागत है",
...
const Dashboard = () => {
  ...
  const generateExcel = (action = 'download') => {
    ...
    if (action === 'download') {
      XLSX.writeFile(wb, `Champawat_रिपोर्ट_${currentDate.replace(/\//g, '-')}.xlsx`);
    } else {
      ...
      setExcelPreviewData({ sheets: sheetData, filename: `Champawat_रिपोर्ट_${currentDate.replace(/\//g, '-')}.xlsx` });
