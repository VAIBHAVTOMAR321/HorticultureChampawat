...
const KendraPasswordReset = () => {
  ...
  useEffect(() => {
    const fetchKendraList = async () => {
      try {
        const response = await axios.get('https://horticulturechampawat.in/champawathorticulture/champawathorticulture_backend/api/reguser-list/');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        'https://horticulturechampawat.in/champawathorticulture/champawathorticulture_backend/api/center-password-change/',
